...
namespace kkrtc {
    namespace vpro {
        ...
        VideoProcessor::VideoProcessor(const KKVideoProcessorAPIs api, const KKMediaFormat &format) {
            LoadPlugin(api, format);
        }

        VideoProcessor::VideoProcessor(const KKVideoProcessorAPIs api) {
            LoadPlugin(api, kkrtc::KKMediaFormat());
        }
