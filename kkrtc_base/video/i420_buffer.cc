...
// static
    kkrtc::scoped_refptr<I420Buffer> I420Buffer::Create(int width, int height) {
        return kkrtc::make_ref_counted<I420Buffer>(width, height);
    }

// static
    kkrtc::scoped_refptr<I420Buffer> I420Buffer::Create(int width,
                                                        int height,
                                                        int stride_y,
                                                        int stride_u,
                                                        int stride_v) {
        return kkrtc::make_ref_counted<I420Buffer>(width, height, stride_y, stride_u,
                                                   stride_v);
    }

// static
    kkrtc::scoped_refptr<I420Buffer> I420Buffer::Copy(
...
// static
    kkrtc::scoped_refptr<I420Buffer> I420Buffer::Copy(int width,
                                                      int height,
        ...
        kkrtc::scoped_refptr<I420Buffer> buffer = Create(width, height);
...
// static
    kkrtc::scoped_refptr<I420Buffer> I420Buffer::Rotate(
...
/*  RTC_CHECK(src.DataY());
  ...
  RTC_CHECK(src.DataV());*/
        ...
        if (rotation == kkrtc::kVideoRotation_90 ||
            rotation == kkrtc::kVideoRotation_270) {
...
/*        RTC_CHECK(libyuv::I420Rect(buffer->MutableDataY(), buffer->StrideY(),
       ...
       int ret =  libyuv::I420Rect(buffer->MutableDataY(), buffer->StrideY(),
                         buffer->MutableDataU(), buffer->StrideU(),
                         buffer->MutableDataV(), buffer->StrideV(), 0, 0,
                         buffer->width(), buffer->height(), 0, 128,
                         128);
