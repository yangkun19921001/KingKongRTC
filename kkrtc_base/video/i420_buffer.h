...
#include "memory/aligned_malloc.h"
...
class RTC_EXPORT I420Buffer : public I420BufferInterface {
 public:
  static kkrtc::scoped_refptr<I420Buffer> Create(int width, int height);
  static kkrtc::scoped_refptr<I420Buffer> Create(int width,
                                               int height,
                                               int stride_y,
                                               int stride_u,
                                               int stride_v);
  ...
  static kkrtc::scoped_refptr<I420Buffer> Copy(const I420BufferInterface& buffer);
  // Deprecated.
  static kkrtc::scoped_refptr<I420Buffer> Copy(const VideoFrameBuffer& buffer) {
    return Copy(*buffer.GetI420());
  }

  static kkrtc::scoped_refptr<I420Buffer> Copy(int width,
                                             int height,
  ...
  static kkrtc::scoped_refptr<I420Buffer> Rotate(const I420BufferInterface& src,
                                               VideoRotation rotation);
  // Deprecated.
  static kkrtc::scoped_refptr<I420Buffer> Rotate(const VideoFrameBuffer& src,
                                               VideoRotation rotation) {
