...
class RTC_EXPORT NV12Buffer : public NV12BufferInterface {
 public:
  static kkrtc::scoped_refptr<NV12Buffer> Create(int width, int height);
  static kkrtc::scoped_refptr<NV12Buffer> Create(int width,
                                               int height,
                                               int stride_y,
                                               int stride_uv);
  static kkrtc::scoped_refptr<NV12Buffer> Copy(
      const I420BufferInterface& i420_buffer);

  kkrtc::scoped_refptr<I420BufferInterface> ToI420() override;
