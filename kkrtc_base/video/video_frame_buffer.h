...
#ifndef VIDEO_FRAME_BUFFER_H_
#define VIDEO_FRAME_BUFFER_H_
...
// kkrtc::VideoFrame, and not here.
class RTC_EXPORT VideoFrameBuffer : public kkrtc::RefCountInterface {
 public:
  ...
  virtual kkrtc::scoped_refptr<I420BufferInterface> ToI420() = 0;
  ...
  virtual kkrtc::scoped_refptr<VideoFrameBuffer> CropAndScale(int offset_x,
                                                            int offset_y,
                                                            int crop_width,
                                                            int crop_height,
                                                            int scaled_width,
  ...
  kkrtc::scoped_refptr<VideoFrameBuffer> Scale(int scaled_width,
                                             int scaled_height) {
  ...
  virtual kkrtc::scoped_refptr<VideoFrameBuffer> GetMappedFrameBuffer(
...
class RTC_EXPORT NV12BufferInterface : public BiplanarYuv8Buffer {
 public:
  ...
  kkrtc::scoped_refptr<VideoFrameBuffer> CropAndScale(int offset_x,
                                                    int offset_y,
                                                    int crop_width,
                                                    int crop_height,
                                                    int scaled_width,
