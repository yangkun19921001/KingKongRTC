...
/*                auto console_sink = std::make_shared<spdlog::sinks::stdout_color_sink_mt>();
                ...
                logger_ = std::make_shared<spdlog::async_logger>("kkrtc_logger", begin(sinks), end(sinks), spdlog::thread_pool(), spdlog::async_overflow_policy::block);
            ...
            void SpdlogLogger::setFileOutput(bool enable, const std::string &filepath) {
                ...
                if (enable) {
                    ...
                    auto file_sink = std::make_shared<spdlog::sinks::rotating_file_sink_mt>(filepath + "/" + file_name, max_file_size, max_files);
